...
\end{equation}
In other words, in each step we add the elements satisfying $\varphi(u_1, \ldots, u_{m-1}, x)$ for those parameters that were either available earlier or were added in the previous step. The final $M$ is obtained by joining all incremental steps together.
\begin{equation}
