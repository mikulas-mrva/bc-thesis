...
% TODOS:
% M \models -> \langle M, \R \rangle \models
...
% zkontrolovat choice
% definice WO mozna nepotrebuje linearitu?
% sjednotit fce, kdy jsou varphi a kdy f?
% pozor na \varphi(x, y) a \varphi[s, t]!
% pozor na to, kdy rikame neco o splnovani ve vlastni tride
% dodelat splnovani, doplnit syntax <X, R> \models \varphi.
