...
Note that Mahlo cardinals were first described in 1911, almost 50 years before Levy's reflection, which was heavily inspired by those. % neco jako ze pouzil podobnou konstrukci, ... jen zjistit k cemu
...
% http://mathreview.uwaterloo.ca/archive/volii/2/measure-cardinality.pdf
% Jech  str. 127
\begin{definition}
...
\newpage
% =====================================================================================================================================
\section{Further reflection} % preformulovat
\subsection{Sharp}
TODO
