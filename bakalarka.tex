...
Lévy (\cite{Levy60a}) proposes those axioms as equivalent to one on his reflection principles. Similar axiom is used in \cite{DrakeBook}, but !!!!.
\begin{definition}{$M$}
...
An interested reader will find the proof in \cite{Levy60a, \emph{Theorem 1}}.

\

% \subsection{posloupnosti modelu}

% TODO $S->ZM->ZM'->ZM''$, neco jako mahlovy kardinaly, presunout do dane kapitoly

% TODO vety o reflexi tak, jak je uvadi kanamori
