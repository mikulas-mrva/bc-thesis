...
\end{displayquote}
We won't spend more time with the philosophy of mathematics as it is outside the scope of this thesis, it is only worth noting that the author usually thinks of reflection in the latter sense which may be (sic) reflected in the way the thesis is written. 
% ma to tam vubec bejt?
% Def mozna Gödel?
