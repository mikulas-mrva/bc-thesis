...
\item If $C$ is a club set in $\alpha$, then there is an ordinal $\beta$ and a function $f: \beta \then \alpha$ such that $rng(f) = C$. We say that $f$ \emph{enumrates} $C$.
...
\ece
\end{lemma}
% http://euclid.colorado.edu/~monkd/m6730/gradsets09.pdf
