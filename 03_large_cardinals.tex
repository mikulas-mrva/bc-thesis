...
The two above definition become equivalent if we assume $GCH$\footnote{}.

TODO smazat GCH viz nize u L, odkazat do sec. 1
...
\begin{equation}
\{ \alpha < \kappa : \langle V_\alpha, \in, R \cap \V_\alpha \ragle \models \varphi \} \in U
\end{equation}
\ece
\end{theorem}
...
\begin{theorem}
Let $\kappa$ be a weakly inaccessible cardinal. Then $\mbox{"$\kappa$ is weakly inaccessible cardinal"}^L$.
\end{theorem}
This is proven in \cite{JechBook}[Theorem 17.22]
