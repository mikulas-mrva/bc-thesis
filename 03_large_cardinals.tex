...
\beq
\bce[(i)]
\item \alpha < \kappa \et (\forall \gamma, \delta \in V_\kappa)(f(\gamma) = \delta \iff (f(\gamma) = \delta)^{V_\kappa})
\item \alpha < \kappa \et \forall \gamma \exists \delta f(\gamma) = \delta \iff (\forall \gamma \exists \delta f(\gamma) = \delta)^{V_\kappa}
\eec
\eeq
%Since $\alpha \in V_\alpha$ for any ordinal $\alpha$ NENENE
