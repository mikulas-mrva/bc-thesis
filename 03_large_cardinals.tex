...
$\Delta^{WTF}_0$ formulas ??? TODO asi vyhodil, podivat se jestli nemuzu ty modely ZFC udelat jinak (poradne) nez pres delta 0 fle.
...
\begin{equation}
\langle V_\beta, \in \rangle \not\models \varphi \varphi(P_1 \cap V_\beta, \ldots, P_n \cap V_\beta)
\end{equation}
\end{definition}
...
\begin{proof}
To see that \ref{eq:inacc_lemma_set} is closed, TODO !!! 

TODO zopakuj definici el. substruktury
...
% \newpage
% =====================================================================================================================================
% Godel Bernays kdyztak Jech str. 70 \cite{JechBook}, ale asi spis nic
