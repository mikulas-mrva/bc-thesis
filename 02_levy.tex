...
%So far we have proven part (i) of this theorem for one formula $\varphi$. 
...
\item \emph{Axiom of Union}:\\ % TODO kontrola % separatni lemma, ze plati v kazdem V_\alpha?
% (see definition \bref{def:union})
%\begin{equation}
...
\item \emph{Axiom of Pairing}: \\ % TODO kontrola
% (see definition \bref{def:pairing})
%\beq
