...
Consider the following formulas. % and $\forall x, p_1, \ldots, p_n \chi$ respectively: 
...
it maps elements of $x$ into $u$. From the axiom scheme of comprehension%\footnote{Lévy uses its equivalent, axiom of subsets},
