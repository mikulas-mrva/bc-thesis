...
which is just a different but equivalent formulation of \emph{Specification}. % todo koukni do churche jak se to s tim ma
...
% zkontrolovano az sem ==========================================================================================
% pojmy "non-simple applied first-order functional calculus" viz \cite{church1996introduction} str. 281 !
% http://math.stackexchange.com/questions/1776765/what-is-non-simple-applied-first-order-functional-calculus-60s-set-theory
...
Let $\sf{Q}$ be an arbitrary axiomatic set theory in first-order logic. 

% TODO konjunkce atomu
%We say the the a class $u$ is a standard model of $\sf{Q}$ with respect to a membership relation $e$, written as $Sm^{\sf{Q}}(u, e)$.
% \bce[(i)]
...
% TODO lemma o tom, ze V_limitni ordinal je model S, bylo presunuto do contemporary restatement
\
...
\begin{equation}
\mbox{"$u$ is a limit ordinal"} \then Scm^{\sf{S}}(u) % spatne!!
\end{equation}
\end{lemma}
