...
\begin{equation}
\exists u (z \in u \eq Scm^{\sf{ZF}}(u) \et (\forall p_1, \ldots, p_m \in u)(\varphi_1 \iff \varphi_1^{u}) \et \ldots \et \varphi_m \iff \varphi_m^{u}))
\end{equation}
\end{definition}
...
\begin{lemma}{($N \iff N'$)}\label{lemma:n_iff_n'}\\
In schema $N$ is equivalent to schema $N'$.
\end{lemma}
...
% TODO mel bych dodat, ze toto u existuje kolem nejake mnoziny $z$, viz N', theorem 2
