...
Given a set $x$, for any $\varphi$, all the elements of $x$ satisfying $\varphi$ form a subset of $x$, which is an element of $\powerset{x}$ and thus also a set if $u$ by \emph{powerset}.
\ece
\end{proof}
