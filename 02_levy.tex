...
We have also shown that it can be used instead of the the \emph{Axiom of Infinity} and the \emph{Replacement Schema} scheme, but \sf{ZFC} + \emph{First-Order Reflection Schema} is no stronger than \sf{ZFC}. Besides being a~starting point for more general and powerful statements, it can be used to show that \sf{ZFC} is not finitely axiomatizable. This follows from the fact that \emph{Reflection} gives a~model to any consistent finite set of formulas. 
...
In the next section, we will try to generalize \emph{Reflection} in a~way that transcends \sf{ZFC} and yields some large cardinals.
\newpage
% =============================================================
